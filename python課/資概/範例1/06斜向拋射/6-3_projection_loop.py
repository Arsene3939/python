...
"""
scene = display(title = "Projection with for loop", width = 800, height = 400, x = 0, y = 0, center = vector(0, 5, 0), \
                          background = vector(0, 0.6, 0.6))
floor = box(pos = vector(0, -size, 0), length = L, height = 0.01, width = 10, color = color.red)
