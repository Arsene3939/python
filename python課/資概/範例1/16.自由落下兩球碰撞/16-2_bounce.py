...
# 產生地板
floor = box(pos = vector(0, -r1, 0), length = L, height = 0.01, width = L, color = color.green)
# 產生小球並設定初速度、加速度
...
# y-t plot
gd = gdisplay(title = "y-t plot", width = 600, height = 450, x = 0, y = 600, xtitle = "t(s)", ytitle = "red: y1, green:y2, blue: y3(m)")
yt1 = gcurve(graph = gd, color = c1)
yt2 = gcurve(graph = gd, color = c2)
yt3 = gcurve(graph = gd, color = c3)
# v-t plot
gd2 = gdisplay(title = "v-t plot", width = 600, height = 450, x = 0, y = 600, xtitle = "t(s)", ytitle = "red: v1, green:v2, blue: v3(m/s)")
