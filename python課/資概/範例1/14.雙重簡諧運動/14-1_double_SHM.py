...
"""
# 產生動畫視窗
scene = display(title = "Double S.H.M.", width = 800, height = 300, center = vector(0, 0.4, 0), background = vector(0, 0.6, 0.6))
# 產生地板
...
gd2 = gdisplay(title = "v - t plot", x = 600, y = 300, width = 600, height = 450, xtitle = "t(s)", ytitle = "red:v1, green:v2(m/s)")
