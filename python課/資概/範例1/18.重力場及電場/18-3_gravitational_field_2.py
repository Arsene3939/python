...
d = 2E7
L = 2*d
scene = display(title = "Gravitatinoal Field", width = 600, height = 600, x = 0, y = 0, background = color.black, range = L)

# 產生地球
earth = planet_c(pos = vector(-d/2, 0, 0), radius = radius["Earth"], m = mass["Earth"], color = color.blue)
