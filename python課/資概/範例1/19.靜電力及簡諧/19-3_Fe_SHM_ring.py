...
"""
# 產生動畫視窗
scene = display(title = "Electric Force and SHM", width = 600, height = 600, x = 0, y = 0, center = vector(0, h, 0), \
...
# 繪圖部分
gd = gdisplay(title = "plot", width = 600, height = 450, x = 0, y = 600, xtitle = "t(s)", ytitle = "blue: y(m), green: v(m/s), magenta: a(m/s^2)")
