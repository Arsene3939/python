...
ball.v = vector(0, 0, 0)
ball.a = vector(0, -g, 0)
gd = gdisplay(title = "y-t(Red), v-t(Yellow), a-t(Green) plot", width = 600, height = 450, x = 300, y = 300, xtitle = "t(s)", ytitle = "y(m)")
#gd2 = gdisplay(title = "v-t plot", width = 600, height = 450, x = 300, y = 300, xtitle = "t(s)", ytitle = "v(m/s)")
#gd3 = gdisplay(title = "a-t plot", width = 600, height = 450, x = 300, y = 300, xtitle = "t(s)", ytitle = "a(m/s^2)")
yt = gcurve(graph = gd, color = color.red)
vt = gcurve(graph = gd, color = color.yellow)
at = gcurve(graph = gd, color = color.green)
