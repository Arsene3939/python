...
"""
# 產生動畫視窗
scene = display(title = "Rutherford Scattering", width = 800, height = 600, x = 0, y = 0, center = vector(0, 0, 0), \
...
# 繪圖部分
gd = gdisplay(title = "Energy - Time Plot", width = 600, height = 450, x = 0, y = 600, xtitle = "t", \
