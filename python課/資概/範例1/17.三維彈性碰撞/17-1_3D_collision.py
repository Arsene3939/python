...
"""
# 產生動畫視窗及小球
scene = display(title = "3D Collision", width = 600, height = 600, x = 0, y = 0, background = vector(0, 0.6, 0.6), range = L)
...
# vx-t plot
gd1 = gdisplay(title = "vx-t plot", width = 600, height = 450, x = 800, y = 0, xtitle = "t(s)", \
           ytitle = "blue: vx1, red:vx2(m/s)")
vxt1 = gcurve(graph = gd1, color = c1)
vxt2 = gcurve(graph = gd1, color = c2)
# vy-t plot
gd2 = gdisplay(title = "vy-t plot", width = 600, height = 450, x = 800, y = 500, xtitle = "t(s)", \
