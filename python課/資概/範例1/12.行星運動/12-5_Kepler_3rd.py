...
"""
scene = display(title = "Kepler's Third Law of Planetary Motion", width = 600, height = 600, x = 0, y = 0, background = color.black)
# 產生太陽 sun, 地球 earth 及自訂行星 planet
sun = sphere(pos = vector(0,0,0), radius = size, m = sun_m, color = color.orange, emissive = True)
earth = sphere(pos = vector(d, 0, 0), radius = size, color = color.blue, make_trail = True, trail_color = color.blue, retain = 365)
