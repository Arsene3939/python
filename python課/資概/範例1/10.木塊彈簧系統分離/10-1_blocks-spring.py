...
"""
scene = display(title = "Blocks and Spring", width = 800, height = 300, center = vector(0, 0.4, 0), background = vector(0, 0.6, 0.6))
...
# 畫 E-t plot
gd = gdisplay(title = "E-t plot", x = 0, y = 300, width = 600, height = 450, xtitle = "t (s)", ytitle = "red: K1, green: K2, orange: U, cyan: E(J)")
...
# 畫 v-t plot
gd2 = gdisplay(title = "v - t plot", x = 0, y = 300, width = 600, height = 450, xtitle = "t (s)", ytitle = "red: v1, green: v2(m/s)")
vt1 = gcurve(graph = gd2, color = c1)
vt2 = gcurve(graph = gd2, color = c2)
# 畫 a-t plot
gd3 = gdisplay(title = "a - t plot", x = 0, y = 300, width = 600, height = 450, xtitle = "t (s)", ytitle = "red: a1, green: a2(m/s^2)")
