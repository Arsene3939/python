...
"""
# 產生動畫視窗
scene = display(title = "Two Blocks", width = 800, height = 300, center = vector(0, 0.4, 0), background = vector(0, 0.6, 0.6))
# 產生地板
...
b2.v = vector(v2, 0, 0)
# 繪圖部分
gd = gdisplay(title = "E - t plot", x = 0, y = 300, width = 600, height = 450, xtitle = "t (s)", ytitle = "red: K1, green: K2, blue: E(J)")
kt1 = gcurve(graph = gd, color = c1)
kt2 = gcurve(graph = gd, color = c2)
et = gcurve(graph = gd, color = color.blue)
gd2 = gdisplay(title = "v - t plot", x = 300, y = 300, width = 600, height = 450, xtitle = "t (s)", ytitle = "red: v1, green: v2(m/s)")
