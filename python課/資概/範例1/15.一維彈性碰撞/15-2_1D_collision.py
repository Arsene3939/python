...
"""
# 產生動畫視窗
scene = display(title = "1 Dimension Collision", width = 800, height = 300, center = vector(0, 0.4, 0), \
...
# 繪圖部分
gd1 = gdisplay(title = "E-t plot", x = 0, y = 300, width = 600, height = 450, xtitle = "t(s)", \
...
gd2 = gdisplay(title = "v-t & a-t plot", x = 0, y = 350, width = 600, height = 450, xtitle = "t(s)",\
